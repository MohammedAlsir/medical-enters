        ...
        <div class="row justify-content-md-center">
            ...
            <div class="col-md-11">
                ...
                <div class="card ">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="POST" action="{{route('checkupes.update' ,$checkup->id)}}" class="form-horizontal">
                        @csrf
                        @method('put')
                        <div class="card-body custom-design">
                            ...
                            <div class="form-group row">
                                ...
                                <input required type="text" class="form-control" value="{{$checkup->ckeckup_name}}" placeholder="أدخل اسم الفحص من فضلك" name="ckeckup_name" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-9 col-xs-8">
                                    <input required type="text" class="form-control" value="{{$checkup->ckeckup_price}}" placeholder="أدخل  سعر الفحص من فضلك" name="ckeckup_price" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-9 col-xs-8">
                                    <input required type="text" class="form-control" value="{{$checkup->ckeckup_time}}" placeholder="أدخل  مدة الفحص من فضلك" name="ckeckup_time" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-9 col-xs-8">
                                     <select name="lab_id" id="" class="form-control" required>
                                         ...
                                         <option value="{{$checkup->Lab_Fun_Relation->id}}"selected>{{$checkup->Lab_Fun_Relation->name}}</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-9 col-xs-8">
                                     <select name="doctor_id" id="" class="form-control" required>
                                         ...
                                         <option value="{{$checkup->Doctor_Fun_Relation->id}}"selected>{{$checkup->Doctor_Fun_Relation->name}}</option>
