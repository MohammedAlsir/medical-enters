        ...
        <div class="row justify-content-md-center">
            ...
            <div class="col-md-11">
                ...
                <div class="card ">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="POST" action="{{route('reservations.update' ,$reservation->id)}}" class="form-horizontal">
                        @csrf
                         @method('put')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-9 col-xs-8">
                                     <select name="medical_center_id" id="" class="form-control" required>
                                         ...
                                         <option value="{{$reservation->MedicalCenter_Fun_Relation->id}}" selected> {{$reservation->MedicalCenter_Fun_Relation->name}}</option>
                                         @foreach ($medical_centers as $m_c)
                                        <option value="{{$m_c->id}}">{{$m_c->name}}</option>
                                         @endforeach
                                     </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-9 col-xs-8">
                                     <select name="doctor_id" id="" class="form-control" required>
                                         ...
                                         <option value="{{$reservation->Doctor_Fun_Relation->id}}" selected> {{$reservation->Doctor_Fun_Relation->name}}</option>
